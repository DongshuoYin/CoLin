...
#CUDA_VISIBLE_DEVICES=7 python tools/train.py peft_mmdet/retinanet/retinanet_dinov2-l-p14-w16_fpn_1x_voc_adaptformer.py
CUDA_VISIBLE_DEVICES=7 python tools/train.py peft_mmdet/retinanet/retinanet_mae-b-p14-w16_fpn_1x_voc_adaptformer.py