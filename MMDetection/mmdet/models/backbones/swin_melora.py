...
# from .melora_layers import MergedLinear
...
class SwinMELoRA(BaseModule):
    ...
    def __init__(
        ...
        super(SwinMELoRA, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(SwinMELoRA, self).train(mode)
        self._freeze_stages()
