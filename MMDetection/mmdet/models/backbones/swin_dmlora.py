...
from mmcv.runner import BaseModule, ModuleList, load_checkpoint, load_state_dict
import torch
...
from .dmlora_layers import MergedLinear
...
class WindowMSA(BaseModule):
    ...
    def __init__(self,
        ...
        self.qkv = MergedLinear(embed_dims, embed_dims * 3, r=INNER_DIM, enable_lora=[True, False, True],
                                bias=qkv_bias)
...
class SwinDMLoRA(BaseModule):
    ...
    def __init__(self,
        ...
        super(SwinDMLoRA, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(SwinDMLoRA, self).train(mode)
        self._freeze_stages()
...
if __name__ == "__main__":
    ...
    for n, p in test_model.named_parameters():
        print(n,p.requires_grad,p.grad_fn)
