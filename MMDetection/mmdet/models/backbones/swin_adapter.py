...
class SwinBlock(BaseModule):
    ...
    def __init__(
        ...
        self.adapter1 = Adapter(embed_dims)
        self.adapter2 = Adapter(embed_dims)
...
class SwinAdapter(BaseModule):
    ...
    def __init__(
        ...
        super(SwinAdapter, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(SwinAdapter, self).train(mode)
        self._freeze_stages()
